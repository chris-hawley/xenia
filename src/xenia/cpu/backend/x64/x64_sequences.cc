...
struct DIV_I8 : Sequence<DIV_I8, I<OPCODE_DIV, I8Op, I8Op, I8Op>> {
  static void Emit(X64Emitter& e, const EmitArgType& i) {
    ...
    constexpr const int8_t minusOne{-1};
    constexpr const int8_t minInt8{INT8_MIN};
    e.inLocalLabel();
...
struct DIV_I16 : Sequence<DIV_I16, I<OPCODE_DIV, I16Op, I16Op, I16Op>> {
  static void Emit(X64Emitter& e, const EmitArgType& i) {
    ...
    Xbyak::Label neg;
    Xbyak::Label normalDiv;
    constexpr const int16_t minusOne{-1};
    constexpr const int16_t minInt16{INT16_MIN};
    e.inLocalLabel();
...
struct DIV_I32 : Sequence<DIV_I32, I<OPCODE_DIV, I32Op, I32Op, I32Op>> {
  static void Emit(X64Emitter& e, const EmitArgType& i) {
    ...
    Xbyak::Label neg;
    Xbyak::Label normalDiv;
    constexpr const int32_t minusOne{-1};
    constexpr const int32_t minInt32{INT32_MIN};
    e.inLocalLabel();
...
struct DIV_I64 : Sequence<DIV_I64, I<OPCODE_DIV, I64Op, I64Op, I64Op>> {
  static void Emit(X64Emitter& e, const EmitArgType& i) {
    ...
    Xbyak::Label normalDiv;
    constexpr const int32_t minusOne{-1};
    constexpr const int64_t minInt64{INT64_MIN};
    e.inLocalLabel();
